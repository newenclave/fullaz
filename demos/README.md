...
| [`gravity/`](gravity) | An interactive Barnes-Hut galaxy simulation using the in-memory 2D orthtree and per-node mass aggregates. | `zig build run-gravity -- [--bodies N] [--theta X] [--dt X] [--seed N]` | `zig build test-gravity` |
