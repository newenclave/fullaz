...
test "Pages: paged R-tree descriptor preserves validated options" {
    const Trait = fullaz.pages.rtree(.{
        .Coord = i64,
        .dimensions = 2,
        .maximum_entries = 4,
...
test "Pages: paged R-tree binding wires transaction and read facades" {
...
test "Pages: R-tree memory database commits and restores its root" {
...
test "Pages: R-tree commits extreme integer boxes after a split" {
    const Schema = fullaz.pages.Schema(.{ .page_id = u32 })
        .add("spatial", fullaz.pages.rtree(.{
        .Coord = i64,
        .dimensions = 2,
...
test "Pages: R-tree memory database reclaims and reuses all pages" {
    const Schema = fullaz.pages.Schema(.{ .page_id = u32 })
        .add("spatial", fullaz.pages.rtree(.{
        .Coord = i64,
        .dimensions = 2,
...
test "Pages: R-tree memory database rolls back a failed root split" {
    const Schema = fullaz.pages.Schema(.{ .page_id = u32 })
        .add("spatial", fullaz.pages.rtree(.{
        .Coord = i64,
        .dimensions = 2,
...
test "Pages: R-tree facade rejects non-finite float MBRs" {
    const Schema = fullaz.pages.Schema(.{ .page_id = u32 })
        .add("spatial", fullaz.pages.rtree(.{
        .Coord = f64,
        .dimensions = 2,
...
test "Pages: two R-tree components share reclamation and keep independent roots" {
    const Schema = fullaz.pages.Schema(.{ .page_id = u32 })
        .add("left", fullaz.pages.rtree(.{
            .Coord = i64,
            .dimensions = 2,
            .maximum_entries = 4,
            .maximum_value_size = 4,
        }))
        .add("right", fullaz.pages.rtree(.{
        .Coord = i64,
        .dimensions = 2,
        .maximum_entries = 4,
        .maximum_value_size = 4,
