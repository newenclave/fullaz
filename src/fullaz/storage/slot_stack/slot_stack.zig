...
pub fn SlotStack(
    ...
    const Chain = slot_chain.BidirectionalHandle(PageCacheT, StorageManagerT, Endian);
    ...
    return struct {
        ...
        pub const Peek = struct {
            ...
            /// The returned slice is valid until `deinit()` or stack mutation.
        ...
        pub fn push(self: *Self, value: ValueIn) Error!void {
